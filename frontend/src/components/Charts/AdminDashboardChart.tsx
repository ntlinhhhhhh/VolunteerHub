...
// // DỮ LIỆU MOCK (Giả lập dữ liệu từ API)
// const MOCK_PENDING = [
//     { id: 'ev-001', title: 'Workshop: UI/UX Design Trends 2025', organizerName: 'Creative Hub', createdAt: '15/12', location: 'Tòa nhà Innovation' },
//     { id: 'ev-002', title: 'Đêm nhạc Indie: Giai điệu mùa đông', organizerName: 'Lofita Band', createdAt: '14/12', location: 'Nhà hát lớn' },
//     { id: 'ev-003', title: 'Giải chạy marathon vì trẻ em', organizerName: 'Hope Foundation', createdAt: '14/12', location: 'Công viên Thống Nhất' },
// ];

// interface DashboardStatsProps {
//     totalUsers: number;
//     eventStats: any; // Linh hoạt theo API của bạn
//     loading: boolean;
// }
...
//     // Ưu tiên dữ liệu thật từ API, nếu không có thì dùng Mock
//     const displayEvents = eventStats?.pendingList?.length > 0 
//         ? eventStats.pendingList.slice(0, 3) 
//         : MOCK_PENDING;

//     if (loading) return <div style={styles.loading}>Đang thiết lập Dashboard...</div>;
...
//                         <p style={styles.miniTitle}>TĂNG TRƯỞNG NGƯỜI DÙNG</p>
...
//                 {/* 2. Card Pending Approvals (MOCK) */}
//                 <div style={styles.glassCard}>
//                     <div style={styles.cardHeader}>
//                         <div>
//                             <p style={styles.miniTitle}>CẦN PHÊ DUYỆT</p>
//                             <span style={{ fontSize: '11px', color: COLORS.textMuted }}>Sự kiện mới gửi yêu cầu</span>
//                         </div>
//                         <button 
...
//                                         <span style={styles.pMeta}><FaUserCircle /> {event.organizerName}</span>
//                                         <span style={styles.pMeta}><FaMapMarkerAlt /> {event.location}</span>
//                                     </div>
//                                 </div>
//                                 <div style={styles.pDate}>{event.createdAt}</div>
//                             </div>
//                         ))}
//                     </div>
//                 </div>
...
//     miniTitle: { fontSize: '11px', fontWeight: 800, color: COLORS.textMuted, letterSpacing: '1.2px' },
...
//     pMeta: { fontSize: '11px', color: COLORS.textMuted, display: 'flex', alignItems: 'center', gap: '4px' },
...
//     dayNum: { aspectRatio: '1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', borderRadius: '12px', transition: 'all 0.2s' },
//     actionBtn: { width: '100%', marginTop: '24px', padding: '14px', borderRadius: '16px', border: 'none', backgroundColor: COLORS.primary, color: '#fff', fontSize: '13px', fontWeight: 700, cursor: 'pointer', boxShadow: '0 10px 15px -3px rgba(99, 102, 241, 0.3)' },
    
//     loading: { padding: '60px', textAlign: 'center', color: COLORS.primary, letterSpacing: '1px', fontWeight: 700 }
// };
...
const COLORS = {
    ...
    warning: '#f59e0b',
    warningLight: '#fffbeb',
    // Đã sửa lại định dạng chuỗi font để chuẩn CSS
