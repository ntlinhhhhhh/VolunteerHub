...
//     // API Configuration
//     const API_BASE_URL = 'http://localhost:4010'; // Posts API
//     const USER_API_URL = 'http://localhost:8000'; // Users & Events API
//     const eventId = '694612a2c0eab2c6832e6e7f';
...
//                 // Process event cover image
//                 if (event.images && Array.isArray(event.images) && event.images.length > 0) {
//                     event.coverImage = event.images[0].startsWith('http')
//                         ? event.images[0]
//                         : `${USER_API_URL}${event.images[0]}`;
//                 } else if (event.image) {
//                     event.coverImage = event.image.startsWith('http')
//                         ? event.image
//                         : `${USER_API_URL}${event.image}`;
//                 }
...
//                     'Content-Type': 'application/json',
//                     'x-user-id': userId,
//                     'x-user-name': userData?.fullName || 'User'
//                 }
//             });
...
//                         <LayoutDashboard size={20} style={styles.navIcon} /> Tổng quan
//                     </div>
//                     <div style={styles.navItem}>
//                         <Search size={20} style={styles.navIcon} /> Duyệt sự kiện
//                     </div>
//                     <div style={styles.navItemActive}>
//                         <MessageSquare size={20} style={styles.navIcon} /> Diễn đàn
//                     </div>
//                     <div style={styles.navItem}>
//                         <UserCircle size={20} style={styles.navIcon} /> Hồ sơ
//                     </div>
//                 </nav>
...
//                                 <div style={styles.dropdownHeader}>Tài khoản</div>
...
//                                 <p style={styles.userName}>{userData?.fullName || 'Người dùng'}</p>
...
//                                 ? `linear-gradient(135deg, rgba(0, 123, 255, 0.85) 0%, rgba(0, 86, 179, 0.85) 100%), url(${eventData.coverImage})`
...
//                                             <span>📅 {new Date(eventData.startDate).toLocaleDateString('vi-VN', {
//                                                 day: '2-digit',
//                                                 month: '2-digit',
//                                                 year: 'numeric'
//                                             })}</span>
...
//                                     )}
//                                 </div>
//                                 <button style={styles.viewEventBtn}>
        ...
        <div style={styles.layout}>
            ...
            <aside style={{
                ...
                <nav style={styles.navMenu}>
                    ...
                    <div style={styles.navItem} onClick={() => navigate('/volunteer/events')}>
                        <Search size={20} style={styles.navIcon} /> Duyệt sự kiện
                    </div>
                    <div style={styles.navItemActive}>
                        <MessageSquare size={20} style={styles.navIcon} /> Diễn đàn
