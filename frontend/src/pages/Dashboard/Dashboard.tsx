...
const styles: { [key: string]: React.CSSProperties } = {
    ...
    eventCategoryTag: { backgroundColor: 'rgba(0, 0, 0, 0.6)', backdropFilter: 'blur(4px)', color: COLORS.WHITE, padding: '6px 12px', borderRadius: '6px', fontSize: '12px', fontWeight: '600', alignSelf: 'flex-start' },
