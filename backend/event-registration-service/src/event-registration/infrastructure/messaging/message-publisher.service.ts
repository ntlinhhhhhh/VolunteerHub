...
//     async notifyEventManagerRegistrationSubmit(eventManagerId: string, eventManagerEmail: string, data: any): Promise<void> {
...
//     async notifyVolunteerEventApproved(eventManagerId: string, eventManagerEmail: string, data: any): Promise<void> {
//         const message: NotificationMessage = {
